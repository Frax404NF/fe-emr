...
import { usePatients, usePatientSearch, usePatientForm } from '../hooks/usePatients';
  ...
  return (
    <form onSubmit={handleFormSubmit} className="space-y-6">
      <div className="bg-gray-50 p-4 rounded-lg">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Tambah Pasien Baru</h3>
        ...
        {/* Kontak Darurat */}
        <div className="mt-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">Kontak Darurat</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
            ...
            <div>
              <label htmlFor="emergency_contact_phonenumber" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('emergency_contact_phonenumber', e.target.value)}
                className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.emergency_contact_phonenumber ? 'border-red-300' : 'border-gray-300'
                }`}
                placeholder="081234567890"
              />
              {errors.emergency_contact_phonenumber && (
                <p className="mt-1 text-sm text-red-600">{errors.emergency_contact_phonenumber}</p>
              )}
            </div>
          </div>
        </div>
        ...
        {/* Riwayat Medis */}
        <div className="mt-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">Riwayat Medis</h4>
          <div className="space-y-4">
            <div>
              <label htmlFor="patient_history_of_allergies" className="block text-sm font-medium text-gray-700 mb-1">
                Riwayat Alergi
              </label>
              <textarea
                id="patient_history_of_allergies"
                value={formData.patient_history_of_allergies}
                onChange={(e) => handleInputChange('patient_history_of_allergies', e.target.value)}
                rows="3"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              <label htmlFor="patient_disease_history" className="block text-sm font-medium text-gray-700 mb-1">
                Riwayat Penyakit
              </label>
              <textarea
                id="patient_disease_history"
                value={formData.patient_disease_history}
                onChange={(e) => handleInputChange('patient_disease_history', e.target.value)}
                rows="3"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{patient.patient_name}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{calculateAge(patient.date_of_birth)} tahun</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{patient.blood_type || 'Tidak diketahui'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{patient.phone_number || 'Tidak ada'}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Kontak Darurat</label>
                <p className="mt-1 text-sm text-gray-900">{patient.emergency_contact_name || 'Tidak ada'}</p>
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700">Nomor Kontak Darurat</label>
                <p className="mt-1 text-sm text-gray-900">{patient.emergency_contact_phonenumber || 'Tidak ada'}</p>
              </div>
            </div>
          </div>
          ...
          {/* Riwayat Medis */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Riwayat Medis</h3>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">Riwayat Alergi</label>
                <p className="mt-1 text-sm text-gray-900">
                  {patient.patient_history_of_allergies || 'Tidak ada riwayat alergi'}
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Riwayat Penyakit</label>
                <p className="mt-1 text-sm text-gray-900">
                  {patient.patient_disease_history || 'Tidak ada riwayat penyakit'}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {patient.created_by && (
                  <>
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-900">{patient.created_by.staff_name}</p>
                    </div>
                    <div>
                ...
                {patient.updated_by && (
                  <>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">Diupdate oleh</label>
                      <p className="mt-1 text-sm text-gray-900">{patient.updated_by.staff_name}</p>
                    </div>
                    <div>
