          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold text-blue-900">Pasien Aktif</h3>
                <p className="text-2xl font-bold text-blue-600">-</p>
                <p className="text-sm text-blue-600">Akan tersedia setelah integrasi encounter</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-green-900">Triage Selesai</h3>
                <p className="text-2xl font-bold text-green-600">-</p>
                <p className="text-sm text-green-600">Akan tersedia setelah integrasi triage</p>
              </div>
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h3 className="font-semibold text-yellow-900">Monitoring</h3>
                <p className="text-2xl font-bold text-yellow-600">-</p>
                <p className="text-sm text-yellow-600">Akan tersedia setelah integrasi vital signs</p>
              </div>
            </div>
          </div>
        </DashboardCard>
